      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div>
          ...
          <p className="text-gray-700 leading-relaxed">
            This website aggregates economics-related seminars and events in and
            near Melbourne, Australia (all broadly defined) with the goal of
            facilitating discovery and exchange across institutions.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <div>
              The following sources are included <b>experimentally</b> as they
              currently need to be scraped:
          ...
          <div className="space-y-3 text-gray-700">
            <div>
              <p className="leading-relaxed">
                We welcome your contributions! Whether you want to add new data
                sources, improve the interface, fix bugs, or suggest new
                features, your help is appreciated.
              </p>
            </div>
            ...
            <div className="flex items-start gap-2 bg-gray-50 rounded-lg p-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Visit the repository to submit issues, pull requests, or
